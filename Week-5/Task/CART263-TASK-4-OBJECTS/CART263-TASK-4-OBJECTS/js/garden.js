 ...
 * 2/ Create the Weed Class : a constructor which takes a position, size and color as parameters （position, size and color）
 ...
 * 
 * 4/ Add a key event listener (in garden.js) such that when the SPACE bar is pressed - a new weed will be added to the garden. （SPACE bar）
